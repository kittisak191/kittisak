        ...
        <div className="row home-row">
          <div className="left col-lg-6 col-md-6 col-sm-12">
            <div data-aos="fade-up" data-aos-duration="3000">
              ...
              <br />
              <p>
                I will take you to visit the website developed by me. Here are
                the details about me. I studied and tried to work in the field
                of programmers for a while. I like and enjoy it in this field.
              </p>
              <br />
